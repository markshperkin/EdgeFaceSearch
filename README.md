...
## Won Second Place in Edge and Neuromorphic Computing class, assessed with latency while achieving minimum accuracy.
## Overview
...
architecture for this problem, achieving an inference latency of 0.0129 seconds and an IoU
accuracy of 40%.
---
## how to run:
### Clone The Repo:
